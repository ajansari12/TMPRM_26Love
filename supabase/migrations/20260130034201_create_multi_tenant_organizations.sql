...
DROP TRIGGER IF EXISTS update_defense_line_configs_updated_at ON defense_line_configs;
CREATE TRIGGER update_defense_line_configs_updated_at
  BEFORE UPDATE ON defense_line_configs
  FOR EACH ROW EXECUTE FUNCTION update_updated_at();

DROP TRIGGER IF EXISTS update_workflow_routing_rules_updated_at ON workflow_routing_rules;
...
DROP TRIGGER IF EXISTS create_defense_configs_on_org_create ON organizations;
